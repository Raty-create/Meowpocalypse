...
// GAME
typedef enum { TITLE, INGAME, PAUSE, GAMEOVER } GAME_STATE;
...
typedef enum { BOSS_DASH = 6, BOSS_MELEE, BOSS_THREE_WAY_CATPAW, BOSS_CIRCULAR_CATPAW, BOSS_JUMP, BOSS_RANDOM_CATPAW, BOSS_SPIRAL_PAWS } BOSS_SKILL_STATE;
